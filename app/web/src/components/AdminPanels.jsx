...
import { Button, Panel, Badge } from "./ui.jsx";
...
export function Overview({ stats, hosted }) {
...
export function UsersTab({ users, limits, onRole, onDelete, onClearUsage, onReload }) {
...
export function DecksTab({ decks }) {
  const [q, setQ] = useState("");
...
export function SystemTab({ stats, hosted, onToggle, onReload }) {
  if (!stats) return null;
  return (
    <div className="space-y-4">
