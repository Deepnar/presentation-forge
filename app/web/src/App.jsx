...
export default function App() {
  ...
  if (!user) {
    ...
    return (
      <div className="relative min-h-screen bg-base">
        <ParticleField boost={2.8} className="pointer-events-none fixed inset-0 z-0 h-full w-full opacity-60" />
  ...
  return (
    <div className={`relative bg-base overflow-x-hidden ${isTourView ? "min-h-screen" : "h-screen overflow-hidden"}`}>
      {isTourView ? <ParticleField boost={2.8} className="pointer-events-none fixed inset-0 z-0 h-full w-full opacity-60" /> : <ParticleField paused={railHover} className="pointer-events-none fixed inset-0 z-0 h-full w-full opacity-40" />}
